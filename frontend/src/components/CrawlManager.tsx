  ...
  return (
    <div>
      ...
      <div className="grid-cards">
        <div className="carved-panel" style={{ maxWidth: '600px', flex: 1 }}>
          <form onSubmit={handleSubmit}>
            ...
            <h3 style={{ fontSize: '1rem', marginTop: '24px', marginBottom: '16px' }}>Advanced Settings</h3>
            ...
            <div className="input-group">
              ...
              />
              <small style={{ color: 'var(--text)', opacity: 0.8 }}>Depth 1 = just this page. Depth 2 = this page and all links on it.</small>
            </div>
            
            <div style={{ display: 'flex', gap: '16px', marginTop: '16px', marginBottom: '24px' }}>
              <label style={{ display: 'flex', alignItems: 'center', gap: '8px', cursor: 'pointer', fontFamily: 'var(--sans)' }}>
                <input 
                  type="checkbox" 
                  checked={useBrowser} 
              ...
              <label style={{ display: 'flex', alignItems: 'center', gap: '8px', cursor: 'pointer', fontFamily: 'var(--sans)' }}>
                <input 
                  type="checkbox" 
                  checked={strictRobots} 
                  onChange={e => setStrictRobots(e.target.checked)}
                  style={{ width: '18px', height: '18px', accentColor: 'var(--accent-base)' }}
                />
        ...
        <div className="carved-panel" style={{ flex: 1 }}>
          <h3 style={{ marginTop: 0 }}>Crawl Engine Rules</h3>
