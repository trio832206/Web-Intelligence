  ...
  return <div style={{
    ...
    height: '100%'
      ...
      gap: '16px'
        ...
        <button className={activeTab === 'users' ? 'btn-primary' : 'btn-secondary'} onClick={() => setActiveTab('users')} style={{
        display: 'flex',
        alignItems: 'center',
        gap: '8px'
      }}>
        ...
        <button className={activeTab === 'security' ? 'btn-primary' : 'btn-secondary'} onClick={() => setActiveTab('security')} style={{
        display: 'flex',
        alignItems: 'center',
        gap: '8px'
      }}>
      ...
      overflowY: 'auto'
        ...
        {loading ? <p>Loading...</p> : error ? <p style={{
        color: 'var(--danger)'
      }}>{error}</p> : activeTab === 'users' ? <div className="data-table-wrapper">
            <table className="data-table">
              ...
              <tbody>
                ...
                fontWeight: 'bold'
                  ...
                  padding: '6px 12px',
                  fontSize: '0.8rem'
                }} disabled={u.is_admin} onClick={() => handleDeleteUser(u.id)}>
                        <Trash2 size={14} />
                      </button>
                    </td>
                  </tr>)}
