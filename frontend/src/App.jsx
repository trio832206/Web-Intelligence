      ...
      zIndex: 1
        ...
        {!isAuthPage && <>
            ...
            isActive
              ...
              <NavLink to="/nlp-analytics" className={({
            isActive
          }) => `nav-item ${isActive ? 'active' : ''}`}>
                <Brain size={20} /> AI & NLP Insights
              </NavLink>

              <NavLink to="/data-fusion" className={({
            isActive
          }) => `nav-item ${isActive ? 'active' : ''}`}>
                <Share2 size={20} /> Data Fusion Engine
              </NavLink>

              <NavLink to="/ml-predictions" className={({
            isActive
          }) => `nav-item ${isActive ? 'active' : ''}`}>
            ...
            isActive
              ...
              <NavLink to="/crawler" className={({
            isActive
          }) => `nav-item ${isActive ? 'active' : ''}`}>
                <Globe size={20} /> New Crawl Job
              </NavLink>

              {localStorage.getItem('isAdmin') === 'true' && <NavLink to="/admin" className={({
            isActive
          }) => `nav-item ${isActive ? 'active' : ''}`}>
            ...
            flex: 1
              ...
              {confirmLogout ? <div className="nav-item" style={{
            marginTop: 'auto',
            marginBottom: '24px',
            ...
            gap: '12px'
              ...
              width: '100%'
                    ...
                    <NavLink to="/login" className="btn-primary" style={{
                padding: '8px 16px',
                fontSize: '0.8em',
                flex: 1,
                textAlign: 'center'
                ...
                </div> : <div className="nav-item" style={{
            marginTop: 'auto',
            marginBottom: '24px'
        ...
        <main className={`main-content ${!isAuthPage ? 'dashboard-content' : 'auth-content'}`}>
          <Routes>
